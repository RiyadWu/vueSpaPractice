...
// 测试导入 1, 2, 3, 4, 5  OK
    // log("Role:", UserCls.getRole())
    // Ajax.loadCustomers(log)
    //
    // DataPool.setWSI({A:"A",B:"B"})
    // log("datapool测试", DataPool.getWSI())
    // log("TotalBlocks:",Fit.getTotalBlocks())
    // log("TotalRegions:",Fit.getTotalRegions())
// --------------------
...
function showRegionByWsi(WSI_ID, WSI_name) {
    Ajax.loadRegionByWSI(WSI_ID, (datas) => {
